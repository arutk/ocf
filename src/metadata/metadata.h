 ...
 */
ocf_cache_line_t
ocf_metadata_hash_get_cachelines_count(struct ocf_cache *cache);
 ...
 * @param cache Cache instance
 */
uint64_t ocf_metadata_hash_get_reserved_lba(ocf_cache_t cache);
...
ocf_cache_line_t
ocf_metadata_hash_get_hash(struct ocf_cache *cache, ocf_cache_line_t index);
